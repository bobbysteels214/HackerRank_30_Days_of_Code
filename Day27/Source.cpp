...
public:
  static vector<int> get_array() { return  vector<int> {}; }
};

class TestDataUniqueValues {
public:
  static vector<int> get_array() { return vector<int> { 1, 2 }; }
  static int get_expected_result() { return 0; }
};

class TestDataExactlyTwoDifferentMinimums {
public:
  static vector<int> get_array() { return vector<int> {5,4,3,3,4,5}; }
